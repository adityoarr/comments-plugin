...
export const TOC_ID: DocsTocItem[] = [
...
export const docsId: DocsContent = {
  eyebrow: 'Panduan Integrasi',
  ...
  intro: (
    <>
      Widget komentar ini bisa dipasang di website apa pun — HTML statis,
      WordPress, Next.js, atau CMS lain — cukup dengan satu tag{' '}
      <code>&lt;div&gt;</code> dan satu tag <code>&lt;script&gt;</code>.
      Tidak perlu install package, tidak perlu database sendiri.
    </>
  ),
  sections: (
    <>
      <Section id="instalasi-cepat" title="1. Instalasi cepat">
        ...
        <p className="font-medium text-zinc-900 dark:text-zinc-100">
          b. Script loader — taruh sekali saja di mana pun setelah wadah di
          atas (idealnya sebelum <code>&lt;/body&gt;</code>):
        </p>
      ...
      <Section id="cara-kerja" title="2. Cara kerja widget">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          ...
          <li>
            Untuk tiap elemen, script membuat satu <code>&lt;iframe&gt;</code>{' '}
            yang sandboxed (terisolasi) dan mengarah ke halaman widget di
            server kami.
          </li>
          <li>
          ...
          <li>
            ...
            berjalan <em>di dalam</em> iframe — tidak ada script dari kami
            yang berjalan langsung di halaman kamu.
          </li>
          <li>
            Iframe mengirim pesan ke halaman induk untuk memberi tahu tinggi
            kontennya, sehingga tinggi iframe otomatis menyesuaikan (tanpa
            scrollbar aneh). Pesan ini divalidasi asalnya, jadi situs lain
      ...
      <Section id="konfigurasi" title="3. Konfigurasi thread ID">
        ...
        <p>
          ...
          &ldquo;terlepas&rdquo; dari halaman barunya. Sebaiknya selalu set{' '}
          <code>data-thread-id</code> secara eksplisit dan jangan mengubahnya
          setelah dipublikasikan.
        </p>
      </Section>

      <Section id="multi-widget" title="4. Beberapa widget dalam satu halaman">
        <p>
          Kamu bisa menaruh lebih dari satu wadah{' '}
          <code>.adityoarr-comments</code> di halaman yang sama — misalnya
          untuk daftar produk yang masing-masing punya komentarnya sendiri.
          Cukup beri <code>data-thread-id</code> yang berbeda untuk tiap
          wadah; satu tag <code>&lt;script&gt;</code> tetap cukup untuk
          menginisialisasi semuanya.
        </p>
...
<script src="https://apps.adityoarr.com/comments-plugin/embed.js" async></script>`}</CodeBlock>
      ...
      <Section id="framework" title="5. Catatan per-framework">
        <p>
          <strong>HTML statis / WordPress / CMS lain:</strong> tempel kedua
          snippet langsung ke template halaman (misalnya{' '}
...
frame-src https://apps.adityoarr.com;`}</CodeBlock>
        <p>
          Tanpa dua directive ini, browser bisa memblokir script loader atau
          iframe widget secara diam-diam — biasanya muncul sebagai error di
          console, bukan error yang terlihat di halaman.
        </p>
      </Section>

      <Section id="dashboard" title="7. Moderasi & dashboard">
        <p>
          Komentar akan tetap tampil walau kamu belum mendaftarkan domain.
          Tapi kalau kamu butuh moderasi (approve/hapus/tandai spam) dan
          pengaturan per situs, daftarkan domain kamu:
        </p>
        <ol className="list-decimal space-y-2 pl-5">
          <li>
            Buka{' '}
          ...
          <li>
            Di dashboard, klik <strong>Add New Site</strong> lalu isi nama
            situs dan domainnya.
          </li>
          <li>
      ...
      <Section id="troubleshooting" title="8. Troubleshooting">
        <p>
          <strong>Widget tidak muncul sama sekali.</strong> Pastikan elemen{' '}
          <code>&lt;div class=&quot;adityoarr-comments&quot;&gt;</code> ada
          di DOM <em>sebelum</em> script <code>embed.js</code> dieksekusi,
          dan cek console browser untuk pesan error CSP atau CORS.
        </p>
        <p>
        ...
        <p>
          <strong>Komentar gagal terkirim.</strong> Cek console untuk error
          dari <code>/api/comments</code> — penyebab paling umum adalah rate
          limit (terlalu banyak komentar dalam waktu singkat) atau koneksi
          yang lambat saat verifikasi token.
        </p>
      </Section>
      ...
      <Section id="faq" title="9. FAQ">
        <p>
          ...
          Tidak. Widget ini berjalan sebagai layanan yang sudah di-hosting —
          kamu hanya menempelkan snippet HTML/JS di atas.
        </p>
        <p>
          <strong>
            Apakah komentar pengunjung memerlukan akun/pendaftaran?
          </strong>{' '}
          Tidak. Secara default pengunjung berkomentar secara anonim; mereka
          tidak diminta membuat akun.
        </p>
        <p>
